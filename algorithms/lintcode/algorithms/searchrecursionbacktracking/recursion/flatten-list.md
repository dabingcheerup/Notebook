...
![](../../../../../.gitbook/assets/screen-shot-2017-08-28-at-5.08.28-pm.png)

## Analysis

### Idea:

recursion 1. 判断是不是integer 是加入result，不是再继续递归地调用函数 non-recursion 1.
...
![](../../../../../.gitbook/assets/screen-shot-2017-08-28-at-5.08.50-pm.png)
